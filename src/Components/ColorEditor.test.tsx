...
describe('ColorEditor Component', () => {
  ...
  it('should render custom colors', () => {
    ...
    const colorEditor = new ColorEditor(props);
    expect(
      colorEditor.renderCustomColors('Red', customColors, 'Custom')
    ).toBeDefined();
  });
  ...
  it('should render custom colors', () => {
    ...
    const colorEditor = new ColorEditor(props);
    expect(
      colorEditor.renderCustomColorsHeader('GreyScale', HeaderColors)
    ).toBeDefined();
  });
  ...
  it('should render custom colors', () => {
    ...
    const colorEditor = new ColorEditor(props);
    expect(
      colorEditor.renderCustomColors('GreyScale', HeaderColors, 'Custom')
    ).toBeDefined();
  });
  ...
  it('should render custom colors', () => {
    ...
    const colorEditor = new ColorEditor(props);
    expect(
      colorEditor.renderCustomColors('RandomColors', HeaderColors, 'Custom')
    ).toBeDefined();
  });
  ...
  it('should render header colors', () => {
    ...
    const colorEditor = new ColorEditor(props);
    expect(
      colorEditor.renderCustomColorsHeader('GreyScale', HeaderColorsEmpty)
    ).toBeDefined();
  });
  ...
  it('should render custom colors', () => {
    ...
    const colorEditor = new ColorEditor(props);
    expect(
      colorEditor.renderCustomColors('RandomColors', HeaderColors, 'Empty')
    ).toBeDefined();
  });
